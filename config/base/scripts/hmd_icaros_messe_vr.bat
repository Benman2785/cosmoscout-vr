...
set SETTINGS=../share/config/icaros_messe_vr_hmd.json
IF NOT "%1"=="" (
  SET SETTINGS=%1
  SHIFT
)
...
set VISTA_INI=display_vr_hmd.ini
IF NOT "%1"=="" (
  SET VISTA_INI=%1
  SHIFT
)
...
cosmoscout.exe --settings=%SETTINGS% -vistaini %VISTA_INI% -newclustermaster VR
